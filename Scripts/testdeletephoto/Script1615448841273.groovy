...
WebUI.click(findTestObject('Object Repository/Page_FLAGSIN/label_Note_ant-checkbox-wrapper'))

WebUI.click(findTestObject('Object Repository/Page_FLAGSIN/span_ACTION'))

WebUI.click(findTestObject('Object Repository/Page_FLAGSIN/li_DELETE'))
