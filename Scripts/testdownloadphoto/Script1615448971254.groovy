...
WebUI.click(findTestObject('Object Repository/Page_FLAGSIN/input_Note_ant-checkbox-input'))

WebUI.click(findTestObject('Object Repository/Page_FLAGSIN/span_ACTION'))

WebUI.click(findTestObject('Object Repository/Page_FLAGSIN/li_DOWNLOAD'))
